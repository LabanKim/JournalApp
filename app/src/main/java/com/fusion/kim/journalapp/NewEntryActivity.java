                ...
                mEntriesRef.push().setValue(entryMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(NewEntryActivity.this, "Entry Saved", Toast.LENGTH_LONG).show();

                        } else {

                            Toast.makeText(NewEntryActivity.this, "Something went wrong. Please try again", Toast.LENGTH_LONG).show();
